...
//data->work_size = 4;  
  char buf[255]; 
//  -cl-std=CL2.0 -cl-uniform-work-group-size -cl-mad-enable  -cl-uniform-work-group-size -fbin-encrypt
  sprintf(data->compiler_options, "-cl-mad-enable -cl-uniform-work-group-size -cl-std=CL2.2 -fbin-encrypt  -I \"%s\" -I \"%s/kernel\" -I \".\" -D WORKSIZE=%d",
