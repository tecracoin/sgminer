...
/*__device__ __force inline __*/ // void copy_block(__local struct mem_blk *dst, __local const struct mem_blk *src) 

/*__device__ __force inline __*/ uint64_t fBlaMka(uint64_t x, uint64_t y) {
